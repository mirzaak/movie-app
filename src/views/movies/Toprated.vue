...
setup(){
  ...
  const loadData = async() => {
    try{
      let popularData = await axios.get('https://api.themoviedb.org/3/movie/top_rated?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&page=1')
  ...
  const loadMore = async() => {
    try{
      ...
      let moreData = await axios.get('https://api.themoviedb.org/3/movie/top_rated?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&page='+number++)
